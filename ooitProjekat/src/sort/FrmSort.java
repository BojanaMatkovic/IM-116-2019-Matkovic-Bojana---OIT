...
public class FrmSort extends JFrame {
	...
	public FrmSort() {
		...
		setBounds(100, 100, 359, 318);
		contentPane = new JPanel();
		contentPane.setBackground(new Color(188, 240, 151));
		...
		pnlSort.setBackground(new Color(188, 240, 151));
		pnlSort.setBorder(new LineBorder(new Color(239, 163, 116), 2));
		...
		toolbar.setBackground(new Color(188, 240, 151));
		...
		btnAdd.setBackground(new Color(188, 240, 151));
		toolbar.add(btnAdd);
		...
		btnSort.setForeground(new Color(4, 4, 3));
		btnSort.setBackground(new Color(188, 240, 151));
		toolbar.add(btnSort);
	}
